    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <Link
            href="/extension"
            className="px-4 py-2.5 text-xs font-bold rounded-xl bg-white text-zinc-900 border border-zinc-200 hover:bg-zinc-50 hover:border-zinc-300 hover:text-black transition-all duration-200 inline-flex items-center justify-center shadow-sm"
          >
            Browser Extension
          </Link>
          <Link
                    ...
                    >
                      <td className="px-5 py-3.5 text-xs font-semibold text-zinc-900">
                        <Link href={`/vaults/${vault.id}`} className="flex items-center gap-3 hover:underline">
                          <div className="w-6 h-6 bg-zinc-50 border border-zinc-200/60 rounded-md flex items-center justify-center flex-shrink-0">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
          {[
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-zinc-50 border border-zinc-200/60 flex items-center justify-center group-hover:bg-zinc-950 group-hover:border-zinc-950 transition-all duration-150">
