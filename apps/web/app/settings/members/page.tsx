                    ...
                    <div className="flex items-center gap-2 flex-shrink-0 ml-3">
                      ...
                      {canEdit ? (
                        <select
                          ...
                          className="text-[10px] font-bold px-2 py-1 rounded-full border cursor-pointer bg-white dark:bg-slate-900 disabled:opacity-50 transition-colors focus:outline-none focus:ring-1 focus:ring-slate-400"
                        >
                      ...
                      {!isSelf && (
                        <button
                          ...
                          title="Grant temporary access to a secret"
